...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini">打开工具栏</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>程序员在囧途</b>后台管理</span>
        </a>
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active treeview">
                <a href="#">
                    <i class="fa fa-dashboard"></i> <span>测试静态菜单</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li class="active"><a href="/Home/Test"><i class="fa fa-circle-o"></i> 测试页面</a></li>
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2015 <a href="http://www.jtthink.com">程序员在囧途教育</a>.</strong> All rights
    reserved.
</footer>
