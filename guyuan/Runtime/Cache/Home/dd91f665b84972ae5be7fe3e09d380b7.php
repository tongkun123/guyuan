                        ...
                        <div class="media-left media-middle">
                            <a href="#">
                                <img class="media-object"
                                     src="/Public/images/php.png" alt="..." style="width:80px;height:80px">
                            </a>
                        </div>
                        <div class="media-body">
                            <h4 class="media-heading"><?php echo ($info["info_title"]); ?></h4>

                            <div class="well"><?php echo ($info["info_des"]); ?></div>
                            <p>
                                <span><script>document.write(getMeta(<?php echo ($info["info_id"]); ?>,"views","点击量:",0));</script></span>  <span><script>document.write(getMeta(<?php echo ($info["info_id"]); ?>,"review","评论数:",0));</script></span>
                            </p>
                        </div>
                    </div>
